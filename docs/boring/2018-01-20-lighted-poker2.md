...
![键盘展示1](//blog-assets.keybrl.com/images/lighted-poker2/1.jpg)
...
![键盘展示1](//blog-assets.keybrl.com/images/lighted-poker2/2.jpg)

原装加厚的PBT键帽和比一代Poker多的钢板让其拥有上乘的击打手感。

![键盘展示1](//blog-assets.keybrl.com/images/lighted-poker2/3.jpg)
...
![加灯所需工具1](//blog-assets.keybrl.com/images/lighted-poker2/4.jpg)  
![加灯所需工具2](//blog-assets.keybrl.com/images/lighted-poker2/5.jpg)
...
![钢丝拔键器](//blog-assets.keybrl.com/images/lighted-poker2/6.jpg)  
![拆好键帽](//blog-assets.keybrl.com/images/lighted-poker2/7.jpg)
...
![大写灯](//blog-assets.keybrl.com/images/lighted-poker2/8.jpg)

拿出一个LED，用电子测试一下，会亮说明LED正常

电子是平的那面是正极。LED是长脚是正极，其实还有一个特征，灯珠里面两块金属不一样大，小的那边是正极（这个特征后面会用到）

![led](//blog-assets.keybrl.com/images/lighted-poker2/9.jpg)  
![试灯](//blog-assets.keybrl.com/images/lighted-poker2/10.jpg)

把管脚剪平（别剪短，把正极剪到和负极一样长就可以了），然后插进轴上预留的灯孔里。注意，标A的那边是正极，或者说，当正视‘Cherry’字样时（为了上灯位，Poker2将轴反着装的。上灯位适合正刻，下灯位适合侧刻），正极在左手边。

![红轴](//blog-assets.keybrl.com/images/lighted-poker2/11.jpg)

插进去之后按一下 `Fn` + `C` 切换灯效或者 + `V` / `B` 调节亮度，看看灯珠是否会亮。要注意用手压着灯珠，不然接触不良。（我是因为刚好放正了位置，不用用手压着）

![键盘试灯](//blog-assets.keybrl.com/images/lighted-poker2/12.jpg)

看见亮光异常兴奋呢

好了继续拆解吧。把键都拔出来之后可以看到钢板上有 **六颗** 固定螺丝，全部拧下来，收好。

![拧螺丝](//blog-assets.keybrl.com/images/lighted-poker2/13.jpg)

然后想办法把板子弄出来，我的方法是拿螺丝刀挂住大写锁定键左边那个空洞然后往上板，固定得还是挺稳的，要用点力。然后就可以把整个钢板连同下面的PCB板一起拿出来了，电源是固定在外壳上的，注意别瞎扯。

![彻底拆开](//blog-assets.keybrl.com/images/lighted-poker2/14.jpg)

仔细观察PCB板上每个轴的位置，都有两个小的焊盘，一个方的一个圆的，跟上面插灯的位置是对应的。就是焊接LED的位置，方的是正极。

![PCB板1](//blog-assets.keybrl.com/images/lighted-poker2/15.jpg)  
![PCB板2](//blog-assets.keybrl.com/images/lighted-poker2/16.jpg)  
![板上试灯](//blog-assets.keybrl.com/images/lighted-poker2/17.jpg)
...
![一堆led](//blog-assets.keybrl.com/images/lighted-poker2/18.jpg)  
![焊接套装](//blog-assets.keybrl.com/images/lighted-poker2/19.jpg)
...
![补锡](//blog-assets.keybrl.com/images/lighted-poker2/20.jpg)

然后把焊咀放中间就可以一次熔两块了，然后把LED顺势插入，将中间的锡拨掉，整一整两个焊点的形状，完工。由于没有三只手，所以没有焊接时的照片...焊好后是这样的

![一个焊好](//blog-assets.keybrl.com/images/lighted-poker2/21.jpg)
...
![全部焊好](//blog-assets.keybrl.com/images/lighted-poker2/22.jpg)

然后拿剪线钳把多余的管脚都剪了，注意剪的时候拿手指按住管脚末端或捏住，避免剪断瞬间断管脚飞起（否则你可能需要护目镜，10倍于断指甲的杀伤力）】

焊点真丑

![全部剪好](//blog-assets.keybrl.com/images/lighted-poker2/23.jpg)

接上电源，翻过来试试能不能全部点亮

![全部剪好](//blog-assets.keybrl.com/images/lighted-poker2/24.jpg)

看到一排排的灯，没有一个不亮的，异常兴奋呢。装上，拧好螺丝把！

![全部装好](//blog-assets.keybrl.com/images/lighted-poker2/25.jpg)

## 完工

有了灯，怎么能不换一套透光键帽呢是吧

![键帽](//blog-assets.keybrl.com/images/lighted-poker2/26.jpg)  
![完工](//blog-assets.keybrl.com/images/lighted-poker2/27.jpg)

其实我还换了10颗彩色增补键，更可爱了

![完工](//blog-assets.keybrl.com/images/lighted-poker2/28.jpg)

最后是灯效演示环节

<video controls="" preload="metadata" width="100%">
    <source src="//blog-assets.keybrl.com/images/lighted-poker2/29.webm" type="video/webm">
