...
![full9](//blog-assets.keybrl.com/images/router/ykl.jpg)
...
![shell1](//blog-assets.keybrl.com/images/router/shell1.jpg)

![shell2](//blog-assets.keybrl.com/images/router/shell2.jpg)

图中的小裁纸刀和铅笔尺子也是主要的加工工具。

主要的加工方法就是画好线，然后拿裁纸刀慢慢划开，根据力道不同，要划十几到几十下才能划透，从两面往中间划比从一面划穿到另一面要容易一点，还是相当累的。除了裁纸刀，我也有一些辅助工具

![shell3](//blog-assets.keybrl.com/images/router/shell3.jpg)
...
![shell4](//blog-assets.keybrl.com/images/router/shell4.jpg)

插入、横着移一下就能卡住。

他们被设计为这样的方向：左右两块是往下移动锁死，这样只要不让左右两块往上移动就可以了，于是底板往后移动锁死左右两块板，上板往左移动锁死前后两块板，这样只要不水平推动上下两块板，整个结构就不会散。而且这些拼插结构加工得也是比较紧的，不容易松动。

![shell5](//blog-assets.keybrl.com/images/router/shell5.jpg)

![shell6](//blog-assets.keybrl.com/images/router/shell6.jpg)

![shell7](//blog-assets.keybrl.com/images/router/shell7.jpg)

然后再考虑内部的结构。首先我需要他能放下一个3.5寸硬盘，为此我买了一个台式机箱的光驱位硬盘架。

![shell8](//blog-assets.keybrl.com/images/router/shell8.jpg)

![shell9](//blog-assets.keybrl.com/images/router/shell9.jpg)

那为了不头重脚轻，应该是硬盘架和硬盘在下面，上面放主板，为了固定方便，中间用木板间隔。大概像这样

![shell10](//blog-assets.keybrl.com/images/router/shell10.jpg)
...
![shell11](//blog-assets.keybrl.com/images/router/shell11.jpg)

因为机箱比较封闭，原来的被动散热看起来也不是很行，于是选择在 CPU 下方的隔板挖个洞放个 8cm 的风扇，风扇是卡在那的，并没有什么胶水、螺丝。隔板上还有一个小洞是用来通下面硬盘的 SATA 和电源线的。

![shell12](//blog-assets.keybrl.com/images/router/shell12.jpg)

背板按照主板上的接口挖有洞，侧板右2左1共3个洞用来固定天线。

![shell13](//blog-assets.keybrl.com/images/router/shell13.jpg)

![shell14](//blog-assets.keybrl.com/images/router/shell14.jpg)

正面挖有一个硬盘架开口的洞，一个固定电源按钮的洞

![shell15](//blog-assets.keybrl.com/images/router/shell15.jpg)
...
![shell16](//blog-assets.keybrl.com/images/router/shell16.jpg)

嵌好侧板、背板、中间隔板

![shell17](//blog-assets.keybrl.com/images/router/shell17.jpg)

用螺丝固定好 USB 延长线、固定主板的铜柱，固定好风扇，将 SATA 和硬盘电源线穿好

![shell18](//blog-assets.keybrl.com/images/router/shell18.jpg)

插上主板底部的风扇控制线

![shell19](//blog-assets.keybrl.com/images/router/shell19.jpg)

理清线，把主板塞进合适的位置，拧上固定螺丝

![shell20](//blog-assets.keybrl.com/images/router/shell20.jpg)

嵌入前板，将各种线插到主板上，理好线

![shell21](//blog-assets.keybrl.com/images/router/shell21.jpg)

嵌入上板，翻转，可以看到底部

![shell22](//blog-assets.keybrl.com/images/router/shell22.jpg)

![shell23](//blog-assets.keybrl.com/images/router/shell23.jpg)

置入硬盘架，插上 SATA 和硬盘电源线，拧好硬盘架两侧的8颗固定螺丝

![shell24](//blog-assets.keybrl.com/images/router/shell24.jpg)

![shell25](//blog-assets.keybrl.com/images/router/shell25.jpg)

嵌入底板，翻转，装上天线，完工（这些做好的板看起来和原来的板色泽不太一样是因为我刷了木油，防潮、防蛀、防腐用的）

![shell26](//blog-assets.keybrl.com/images/router/shell26.jpg)

![shell27](//blog-assets.keybrl.com/images/router/shell27.jpg)
...
![shell30](//blog-assets.keybrl.com/images/router/shell30.jpg)

这个的制作方式和组合基本原理和上面那个差不多，就不详细说明了，放几张图吧

![shell31](//blog-assets.keybrl.com/images/router/shell31.jpg)

![shell32](//blog-assets.keybrl.com/images/router/shell32.jpg)

![shell33](//blog-assets.keybrl.com/images/router/shell33.jpg)

![shell34](//blog-assets.keybrl.com/images/router/shell34.jpg)

![shell35](//blog-assets.keybrl.com/images/router/shell35.jpg)

明显可爱多了不是吗，而且也更像一个路由器了！

如果需要接硬盘的话，侧边有一个隐蔽的开口可以把 SATA 和硬盘电源线透出来

![shell36](//blog-assets.keybrl.com/images/router/shell36.jpg)
